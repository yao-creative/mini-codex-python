...
class CommandQueueManager:
    ...
    #mutation/ evaluator state x event. an event is a function on state.
    @staticmethod
    def apply(state: CommandQueueState, event: CommandQueueEvent) -> Result[Command | None, QueueEmpty | CommandNotFound]:
        match event:
    ...
    @staticmethod
    def cancel(state: CommandQueueState, command_id: str) -> Result[None, CommandNotFound]:
        """
